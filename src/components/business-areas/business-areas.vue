...
<script>
    export default {
      ...
      mounted() {
        ...
        this.$http.get("http://58.43.196.11:3001/api/contents?currentPage=1&type=china&deleted=false&pageSize=100").then(function(res){
          var msg = res.body;
          if(msg.code === 200){
        ...
        var _this = this;
        this.$http.get("http://58.43.196.11:3001/api/contents?currentPage=1&type=international&deleted=false&pageSize=100").then(function(res){
          var msg = res.body;
          if(msg.code === 200){
